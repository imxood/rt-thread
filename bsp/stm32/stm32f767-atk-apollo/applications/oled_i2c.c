...
#define OLED_DEVICE_NAME		"i2c1"

static struct rt_i2c_bus_device *oled_i2c_dev;

void I2C_WriteByte(uint8_t addr,uint8_t data)
{
	rt_i2c_master_send(oled_i2c_dev, OLED_ADDRESS, RT_I2C_WR, &data, 1);
...
{
    oled_i2c_dev = rt_i2c_bus_device_find(OLED_DEVICE_NAME);
